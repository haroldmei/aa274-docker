...
curl -O https://storage.googleapis.com/nvidia-drivers-us-public/GRID/GRID9.0/NVIDIA-Linux-x86_64-430.30-grid.run
sudo apt install build-essential xorg
sudo bash NVIDIA-Linux-x86_64-430.30-grid.run
